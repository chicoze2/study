...
<body>
    ...
    <?php
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $retrun = insereRegistro($conexao, $descricao, $modelo, $quantidade, $valor);
            if($return){
                echo "<h3>Registro adicionado com sucesso</h3>";
            }else{
                echo "<h3>Erro ao adicionar registro</h3>";
            }
        }
...
<a href="http://localhost/versao2/index.php"/>Voltar para a lista</a>
